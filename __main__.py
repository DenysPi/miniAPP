...
async def start(message: types.Message):
    ...
    text = (
        ...
        "Наш софт, построенный на Al модели, выдающий сигналы с общей проходимостью 90%, также софт может дать не точный сигнал, вы должны понимать что софт это не волшебная таблетка, а дополнение, и увеличение шанса на выиграш!\n\n"

        "Для получения точных сигналов тебе нужно пройти регистрацию по ссылке ниже используя промокод: <b>2WINERR</b> +500% к депозиту, таким образом бот подвяжется к вашему акаунту, и будет давать правильные сигналы."
        )
